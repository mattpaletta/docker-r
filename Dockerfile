...
ARG TIDYVERSE=0
ARG R_VERSION=3.5.0
RUN yum install -y openssl-devel libssh2-devel wget xz-devel java-1.8.0-openjdk-devel pcre-devel curl-devel make gcc-c++ gcc-gfortran zlib-devel bzip2-devel perl libxml2-devel https://dl.fedoraproject.org/pub/epel/7/x86_64/Packages/u/udunits2-devel-2.2.20-2.el7.x86_64.rpm
